...
if __name__ == "__main__":
    ...
    parser.add_argument("--skip-attention", action="store_true", help="Skip extraction of attention map")
    parser.add_argument("--skip-all-embedding", action="store_true", help="Skip extraction of all embedding")
    parser.add_argument("--skip-cls-embedding", action="store_true", help="Skip extraction of cls embedding")
    ...
    if not args.skip_cls_embedding:
    ...
    if not args.skip_all_embedding:
